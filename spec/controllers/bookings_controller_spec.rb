  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved booking as @booking" do
        ...
        post :create, {:booking => { "booking_date" => "invalid value" }}, valid_session
        assigns(:booking).should be_a_new(Booking)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested booking" do
        ...
        Booking.any_instance.should_receive(:update_attributes).with({ "booking_date" => "2013-03-03" })
        put :update, {:id => booking.to_param, :booking => { "booking_date" => "2013-03-03" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the booking as @booking" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Booking.any_instance.stub(:save).and_return(false)
        put :update, {:id => booking.to_param, :booking => { "booking_date" => "invalid value" }}, valid_session
        assigns(:booking).should eq(booking)
      end
