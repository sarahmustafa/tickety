  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved reward as @reward" do
        ...
        post :create, {:reward => { "reward_title" => "invalid value" }}, valid_session
        assigns(:reward).should be_a_new(Reward)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested reward" do
        ...
        Reward.any_instance.should_receive(:update_attributes).with({ "reward_title" => "MyString" })
        put :update, {:id => reward.to_param, :reward => { "reward_title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the reward as @reward" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Reward.any_instance.stub(:save).and_return(false)
        put :update, {:id => reward.to_param, :reward => { "reward_title" => "invalid value" }}, valid_session
        assigns(:reward).should eq(reward)
      end
