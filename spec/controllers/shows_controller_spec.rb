  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved show as @show" do
        ...
        post :create, {:show => { "show_time" => "invalid value" }}, valid_session
        assigns(:show).should be_a_new(Show)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested show" do
        ...
        Show.any_instance.should_receive(:update_attributes).with({ "show_time" => "2013-03-03 11:16:02" })
        put :update, {:id => show.to_param, :show => { "show_time" => "2013-03-03 11:16:02" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the show as @show" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Show.any_instance.stub(:save).and_return(false)
        put :update, {:id => show.to_param, :show => { "show_time" => "invalid value" }}, valid_session
        assigns(:show).should eq(show)
      end
