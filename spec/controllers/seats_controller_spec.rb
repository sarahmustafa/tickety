  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved seat as @seat" do
        ...
        post :create, {:seat => { "number" => "invalid value" }}, valid_session
        assigns(:seat).should be_a_new(Seat)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested seat" do
        ...
        Seat.any_instance.should_receive(:update_attributes).with({ "number" => "1" })
        put :update, {:id => seat.to_param, :seat => { "number" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the seat as @seat" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Seat.any_instance.stub(:save).and_return(false)
        put :update, {:id => seat.to_param, :seat => { "number" => "invalid value" }}, valid_session
        assigns(:seat).should eq(seat)
      end
